...
alert('Wanna talk for just a second + username + ? Answer yes or no y/n');
 ...
 let questionOne = prompt('Do you like Grey/s Anatomy? Type yes or no');
...
alert('me either I dont watch it')
 ...
 let questionTwo = prompt('Do you live in washington state');
...
let questionThree = prompt('Have you ever been in the service');
...
let questionFour = prompt('Do you have a dream job');
